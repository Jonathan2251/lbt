...
static int naive_popcount(ti_int a)
{
    int r = 0;
    for (; a; a = (tu_int)a >> 1)
        r += a & 1;
...
static int test__popcountti2(ti_int a)
{
...
static char assumption_1[sizeof(ti_int) == 2*sizeof(di_int)] = {0};
static char assumption_2[sizeof(di_int)*CHAR_BIT == 64] = {0};

#endif

int popcountti2_test()
{
#ifdef CRT_HAS_128BIT
