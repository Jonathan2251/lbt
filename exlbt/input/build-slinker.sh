...
${TOOLDIR}/llc -march=cpu0${endian} -mcpu=${CPU} -relocation-model=static \
-filetype=obj ch8_2_phinode.bc -o ch8_2_phinode.cpu0.o
${TOOLDIR}/llc -march=cpu0${endian} -mcpu=${CPU} -relocation-model=static \
...
ch8_1_5.cpu0.o ch8_2_phinode.cpu0.o ch8_blockaddr.cpu0.o ch8_2_longbranch.cpu0.o \
ch9_3_detect_exception.cpu0.o ch_slinker.cpu0.o lib_cpu0.o -o a.out
