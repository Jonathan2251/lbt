...
latex_documents = [
    (master_doc, 'LLVMToolchainCpu0.tex', u'Tutorial: Creating an LLVM Toolchain for the Cpu0 Architecture',
...
# Disable loading intersphinx inventory from https://docs.python.org/objects.inv...
