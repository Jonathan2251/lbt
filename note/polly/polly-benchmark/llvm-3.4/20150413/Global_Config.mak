...
#CROSS_COMPILE := /home/cschen/test/compile-benchmark-with-polly/llvm-3.4-arm-hard-x86_64-201410/bin/arm-linux-gnueabihf-
CROSS_COMPILE := /home/cschen/test/polly/cmake_arm_hard_debug_build/bin/
...
#XCFLAGS := -Xclang -load -Xclang ~/test/polly/cmake_arm_hard_debug_build/lib/LLVMPolly.so -mllvm -polly -mllvm -polly-ignore-aliasing
#XCFLAGS := -Xclang -load -Xclang ~/test/polly/cmake_arm_hard_debug_build/lib/LLVMPolly.so -mllvm -polly -mllvm -enable-polly-openmp -lgomp -mllvm -polly-ignore-aliasing
XCFLAGS :=
